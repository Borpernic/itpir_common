...
@Service
public class NomenclatureWorksServiceImpl implements NomenclatureWorksService {

    private final NomenclatureWorksRepository repository;

    @Autowired
    public NomenclatureWorksServiceImpl(NomenclatureWorksRepository repository) {
        this.repository = repository;
    }


    @Override
    public NomenclatureWorksEntity create(NomenclatureWorksEntity entity, int userId) {
    ...
    @Override
    public NomenclatureWorksEntity update(NomenclatureWorksEntity entity) throws NotFoundException {
    ...
    @Override
    public NomenclatureWorksEntity update(NomenclatureWorksEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public NomenclatureWorksEntity get(int id) throws NotFoundException {
