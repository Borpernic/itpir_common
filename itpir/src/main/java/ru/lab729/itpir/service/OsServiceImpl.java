...
public class OsServiceImpl implements OsService {
    ...
    @Autowired
    public OsServiceImpl(OsRepository repository) {
        this.repository = repository;
    }


    @Override
    public OsEntity create(OsEntity entity, int userId) {
    ...
    @Override
    public OsEntity update(OsEntity entity) throws NotFoundException {
    ...
    @Override
    public OsEntity update(OsEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public OsEntity get(int id) throws NotFoundException {
