...
@Service
public class StatusContactServiceImpl implements StatusContactService {

    private final StatusContactRepository repository;

    @Autowired
    public StatusContactServiceImpl(StatusContactRepository repository) {
        this.repository = repository;
    }


    @Override
    public StatusContactsEntity create(StatusContactsEntity entity, int userId) {
    ...
    @Override
    public StatusContactsEntity update(StatusContactsEntity entity) throws NotFoundException {
    ...
    @Override
    public StatusContactsEntity update(StatusContactsEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public StatusContactsEntity get(int id) throws NotFoundException {
