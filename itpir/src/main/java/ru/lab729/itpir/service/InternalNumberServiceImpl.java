...
@Service
public class InternalNumberServiceImpl implements InternalNumberService {

    private final InternalNumberRepository repository;

    @Autowired
    public InternalNumberServiceImpl(InternalNumberRepository repository) {
        this.repository = repository;
    }


    @Override
    public InternalNumberEntity create(InternalNumberEntity entity, int userId) {
    ...
    @Override
    public InternalNumberEntity update(InternalNumberEntity entity) throws NotFoundException {
    ...
    @Override
    public InternalNumberEntity update(InternalNumberEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public InternalNumberEntity get(int id) throws NotFoundException {
