...
public class CommentsServiceImpl implements CommentsService {
    ...
    @Override
    public CommentsEntity create(CommentsEntity entity, int userId) {
    ...
    @Override
    public CommentsEntity update(CommentsEntity entity) throws NotFoundException {
    ...
    @Override
    public CommentsEntity update(CommentsEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public CommentsEntity get(int id) throws NotFoundException {
