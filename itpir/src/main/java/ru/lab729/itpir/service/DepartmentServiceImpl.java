...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Override
    public DepartmentEntity create(DepartmentEntity entity, int userId) {
    ...
    @Override
    public DepartmentEntity update(DepartmentEntity entity) throws NotFoundException {
    ...
    @Override
    public DepartmentEntity update(DepartmentEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public DepartmentEntity get(int id) throws NotFoundException {
