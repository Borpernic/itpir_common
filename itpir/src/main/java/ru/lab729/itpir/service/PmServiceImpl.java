...
public class PmServiceImpl implements PmService {
    ...
    @Autowired
    public PmServiceImpl(PmRepository repository) {
        this.repository = repository;
    }


    @Override
    public PmEntity create(PmEntity entity, int userId) {
    ...
    @Override
    public PmEntity update(PmEntity entity) throws NotFoundException {
    ...
    @Override
    public PmEntity update(PmEntity entity, int userId) {
        return checkNotFoundWithId(repository.save(entity, userId), entity.getId());
    }

    @Override
    public PmEntity get(int id) throws NotFoundException {
