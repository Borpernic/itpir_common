...
@Repository
public class DataJpaContactsAdRepositoryImpl implements SiteRepository {
    ...
    @Autowired
    public DataJpaContactsAdRepositoryImpl(CrudSiteRepository crudSiteRepository, CrudUserRepository crudUserRepository) {
