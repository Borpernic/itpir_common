...
<%@ taglib prefix="itpir" tagdir="/WEB-INF/tags" %>
...
<div class="jumbotron pt-4">
    <div class="container">
        <%--@elvariable id="userTo" type="ru.lab729.itpir.to.UserTo"--%>
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form modelAttribute="userTo" class="form-horizontal" method="post" action="${register ? 'register' : 'profile'}"
                    ...
                    <itpir:inputField labelCode="user.name" name="name"/>
                    <itpir:inputField labelCode="user.email" name="email"/>
                    <itpir:inputField labelCode="user.password" name="password" inputType="password"/>
                    <itpir:inputField labelCode="user.caloriesPerDay" name="caloriesPerDay" inputType="number"/>
