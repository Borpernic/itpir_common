...
VALUES ('МТС', 'оператор МТС ', 100001),
  ('Билайн', 'оператор Билайн', 100001),
...
VALUES ('1279', 'Будапешт', 100010, 100013, '2018-05-30 13:00:00', 'Москва', 'Авиамоторная', '28С', ' БС 1279', 100001),
  ('1280', 'Будапешт2', 100010, 100013, '2018-05-30 13:00:00', 'Москва', 'Автозаводская', '18С', ' БС 1280', 100001),
...
INSERT INTO os (date_time, site, internal_number, curator, band, type_os, type_BS, type_AMS, type_AFS, status_os, comments, user_id)
...
VALUES
  (
    ...
    'акт', 4800, 100048, 100084, 'Модернизация', 100001),
  ('1.1. Обследование площадки, сбор исходных данных (модернизация БС).', 'шт.', 1400, 100048, 100084, 'Модернизация', 100001),
  ('1.2. Подготовка отчета по обследованию площадки SSR', 'шт.', 1300, 100048, 100084, 'Модернизация', 100001),
  ('1.3. Составление и согласование Акта обследования с Заказчиком при модернизации существующего объекта', 'акт', 2100, 100048, 100084, 'Модернизация', 100001),
  ('2. Обследование площадки, сбор исходных данных, составление и согласование Акта обследования с (новое строительство БС).', 'альбом', 4800, 100047, 100084, 'Новая стройка', 100001),
  ('2.1. Обследование площадки, сбор исходных данных (новое строительство БС).', 'шт.', 1600, 100047, 100084, 'Новая стройка', 100001),
  ('2.2. Составление и согласование Акта обследования с Заказчиком для новой стройки', 'шт.', 3200, 100047, 100084, 'Новая стройка', 100001),
  ('3. Разработка основного комплекта рабочих чертежей марки АС при выполнении работ по модернизации', 'альбом', 1400, 100048, 100084, 'Модернизация', 100001),
  ('4. Разработка основного комплекта рабочих чертежей марки РС при модернизации БС', 'альбом', 1400, 100048, 100084, 'Модернизация', 100001),
  ('5. Разработка основного комплекта рабочих чертежей марки ЭМ при выполнении работ по модернизации БС', 'альбом', 1400, 100048, 100084, 'Модернизация', 100001),
  ('6. Разработка основного комплекта рабочих чертежей марки РРС', 'альбом', 1400, 100048, 100084, 'Модернизация', 100001),
  ('7. Разработка основного комплекта рабочих чертежей марки РРС1', 'альбом', 1400, 100048, 100084, 'Модернизация', 100001),
  ('8. Разработка основного комплекта рабочих чертежей марки ЭС (включая ТУ на электроснабжение + акт разграничения БП)', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
  ('9. Разработка основного комплекта рабочих чертежей марки КМ', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
  ('10. Разработка основного комплекта рабочих чертежей марки КЖ', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
  ('11. Разработка основного комплекта рабочих чертежей марки МЗ', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
  ('12. Разработка основного комплекта рабочих чертежей марки ОВ', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
  ('13. Разработка основного комплекта рабочих чертежей марки ООС', 'альбом', 1400, 100047, 100084, 'Новая стройка', 100001),
...
INSERT INTO task (activity, date_time, type_task, department, plane_date_time, right_on_time, approve, approve_date_time, result_task, user_id)
