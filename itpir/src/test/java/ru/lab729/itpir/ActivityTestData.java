...
public class ActivityTestData {
    ...
    public static final ActivityEntity ADMIN_ACTIVITY3 = new ActivityEntity(ACTIVITY1_ID, OS1, IMPLEMENTER1, ADMIN_TYPE_ACTIVITY3,
            of(2019, Month.MAY, 30, 13, 0), of(2015, Month.MAY, 30, 13, 0),
            BigInteger.ONE, STATUS_ACTIVITY1, null, "Задача 3");

    public static final List<ActivityEntity> ALL_ACTIVITYS = Arrays.asList(ADMIN_ACTIVITY3, ACTIVITY2, ACTIVITY1);

    public static ActivityEntity getCreated() {
        return new ActivityEntity(null, OS1, IMPLEMENTER1, TYPE_ACTIVITY1,
                of(2019, Month.MAY, 30, 13, 0), of(2015, Month.MAY, 30, 13, 0),
